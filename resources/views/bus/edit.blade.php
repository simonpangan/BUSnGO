        ...
        <div class="mx-auto border rounded p-3" style="width: 500px">
            ...
            <form method="post" action="{{ route('admin.buses.update', $bus->id) }}" enctype="multipart/form-data">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control @error('seat') is-invalid @enderror" id="seat"
                               name="seat"
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control @error('engine_model') is-invalid @enderror"
                               id="engine_model" name="engine_model"
                               value="{{ old('engine_model', $bus->engine_model) }}"
                               required/>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control @error('chassis_no') is-invalid @enderror"
                               id="chassis_no"
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control @error('register_no') is-invalid @enderror"
                               id="register_no"
                ...
                <div class="mb-3 row">
                    <label for="transmission_model" class="col-md-4 col-form-label text-md-end">Transmission
                        Model</label>
                    <div class="col-md-6">
